...
$sqlpost = "SELECT user.nombre, user.apellido, eve.ID, eve.titulo_evento, eve.desc_evento,
eve.foto_evento, eve.fecha_ini_evento, eve.fecha_final_evento, eve.user_id FROM usuarios as user, eventos_posts as eve WHERE eve.user_id=user.ID ORDER BY eve.ID DESC";
                        ...
                        ?>
                            <div class="container publicacion">
                                    <div class="row post-header">
                                        ...
                                        <span class="nav-item"><?php echo $row['nombre'] . ' ' . $row['apellido'];?></span>
