...
$sqlID = "SELECT ID FROM usuarios WHERE correo = '$email' and num_cuenta = '$nucuenta' and contrasenia = '$pwd' ";
$resultID = mysqli_query($conn, $sqlID);
if (!$resultID) die("Fatal Error");
$row = $resultID->fetch_array(MYSQLI_ASSOC);
$_SESSION['id'] = $row['ID'];

$sqlFeed = "SELECT user.nombre, user.apellido, pos.ID, pos.descripcion FROM usuarios as user, posts as pos 
WHERE pos.user_ID = user.ID ORDER BY pos.ID DESC";
$sqlResult =  mysqli_query($conn, $sqlFeed);
...
<body>
        ...
        <ul>
            <li>
                <a href="main.php" class="logo-sidebar">
                    <img src="images/logo1.png" class="img-fluid logo-unitec" alt="unitec_mini" width="50" height="50"
                        maxheight="50%">
                </a>
            </li>
            <li class="nav-1">
            ...
            <li class="nav-4">
                ...
                <ul class="dropdown-container">
                    <li class="nav-4">
                        ...
                        <a href="#" type="button" data-toggle="modal" data-target="#subir-publicacion"
                            class="icon-sidebar">
                            <i class="fas fa-plus"></i>
                    ...
                    <li class="nav-4">
                        <a href="#" type="button" data-toggle="modal" data-target="#subir-historia"
                            class="icon-sidebar">
                            <i class="fas fa-plus"></i>
    ...
    <div class="modal fade" id="subir-historia" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
